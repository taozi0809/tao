    ...
    <div class="head" :class="isCollapse?'head-pack-up':'head-unfold'">
        ...
        <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
                ...
                <li class="el-dropdown-menu__item" @click="goHome">{{gameName==0?'应用宝斗地主':'圈圈斗地主'}}</li>
...
<script>
    ...
    export default {
        data(){
            return{
                account:getLocalStore('mixing_account')
            }
        },
        computed:{
        ...
        methods:{
            ...mapMutations(['MIXING_TOKEN','ISCOLLAPSE','GAMENAME']),
            handleCollapse(){
            ...
            goHome(){
                this.GAMENAME(this.gameName==0?'1':'0')
