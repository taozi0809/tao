...
var token = getLocalStore('mixing_token')!=null?getLocalStore('mixing_token'):''
...
const routes = [
  ...
  {path:'/home', name: 'home', component: () => import('@/views/home/home'),
    children:[
      ...
      {path:'/channel_record', name: 'channel_record', component: () => import('@/views/data_report/channel_record')},
...
router.beforeEach((to, from, next) => {
  ...
  var isLogin = !!store.state.mixing_token
