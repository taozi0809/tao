        ...
        <div class="list">
            <el-table :data="list" border style="width: 100%" height="620" v-loading="loading" element-loading-text="加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(255, 255, 255, 0.6)">
                ...
                <el-table-column fixed="right" label="操作" width="200">
                    <template slot-scope="scope">
                        <el-button type="danger" size="small" v-if="scope.row.islock==0" @click="lock(scope.row,'1')">锁定下注</el-button>
...
<script>
    import {allCurrType,allLeagueName,matchDetail,matchLocak} from "../../service/hapi";
