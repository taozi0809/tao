        ...
        <div class="main">
            <div class="con">
                ...
                <div class="card">
                    ...
                    <div class="item i5" @click.stop="POPOVER('12')">
                        <div class="l">红包个数</div>
                        <div class="r">
                            <input type="text" :placeholder="'本群共'+JSON.parse(chatInfo.params).userIdCodes.length+'人'" v-model="size">
                            <div class="last">个</div>
                        </div>

                    </div>
                    <div class="item i2" @click.stop="POPOVER('12')">
                        <div class="l">总金额</div>
                        <div class="r">
                            <input type="text" placeholder="输入金额" v-model="sum" autofocus>
                        </div>
                    </div>
                    <div class="item i3" @click.stop="POPOVER('12')">
                    ...
                    <div class="switch" @click.stop="POPOVER('13')">当前所有成员可抢，<span>改为指定人领取</span></div>
                </div>
            </div>
        </div>
        <message ref="message"/>
...
<script>
    ...
    import {balanceList,packetCreateNormalGroup} from "../service/api";
    ...
    export default {
        ...
        methods:{
            ...
            sendPacket(){
                if(this.size>0){}else{
                    this.$refs.message.Message('红包个数错误');
                    return
                }
                if(this.sum>0){
                    var coin={}
                    ...
                    packetCreateNormalGroup(this.userInfo.userName,this.token,this.chatInfo.groupIdCode,'GROUP',coin.coinName,coin.moneyCode,this.size,this.sum,!!this.desc?this.desc:'恭喜发财').then(res=>{
