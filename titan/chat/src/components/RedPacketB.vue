        ...
        <div class="main">
            <div class="con">
                ...
                <div class="item1">
                    ...
                    <div class="num">抢<span class="max">{{robSum}}</span>{{JSON.parse(JSON.parse(packetInfo.param).data).coinName}}</div>
    ...
    export default {
        ...
        created:function(){
            ...
            getPacketInfo(this.userInfo.userName,this.token,JSON.parse(JSON.parse(this.packetInfo.param).data).packetId,JSON.parse(JSON.parse(this.packetInfo.param).data).packetUserIdCode).then(res=>{
                ...
                if(res.code==0){
                    // this.res=res.data
                    this.robSum = res.data.packetDetailCtoModels.filter((item)=>{return item.idCode==this.userInfo.idCode})[0].sum
