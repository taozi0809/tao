    ...
    <div class="banner">
        <div class="notstarted" v-if="data.statusType=='notstarted'">
            <div class="notstarted-div l">
                <span><img :src="data.homeLogo" alt="" :onerror="errorDeImg"></span>
                <p>{{data.homeName}}</p>
            </div>
            ...
            <div class="notstarted-div r">
                <span><img :src="data.guestLogo" alt="" :onerror="errorDeImg"></span>
                <p>{{data.guestName}}</p>
            </div>
        </div>
...
<script>
    import {football_match_details,basketball_all_or_leagueId_match_name} from "../../service/api";
    ...
    export default {
        ...
        created:function(){
            ...
            basketball_all_or_leagueId_match_name('1','10','2',[this.matchId]).then(res=>{
