<template>
    <div class="register">
        <span class="home-bg"><img src="../../assets/img/invitationRegister/home-bg.png" alt=""></span>
    ...
    export default {
        ...
        methods:{
            handleLinkToDownload(){
                this.$router.push('/invitationRegisterDownload')
            },
            handleRegister(){
...
<style lang="scss" scoped>
    .register{
        ...
        height: 100%;
        overflow: hidden;
        background: url("../../assets/img/invitationRegister/bg.png") no-repeat;
        background-size: 100%;
        .home-bg{
            width: 100%;
            display: block;
