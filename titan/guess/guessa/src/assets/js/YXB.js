...
export const YXB = {
    ...
    // --------------------------------------------------------
    url : {
        coin : "http://api.core.titan.shenzhouxing.com",
        jc : "http://api.quiz.titan.shenzhouxing.com",
        lqjc:'http://212.64.6.16:7009',

        // jc : 'http://192.168.1.46:7007',   //本地
        // lqjc : 'http://192.168.1.46:7009',//本地

        // titanRegister:'http://api.link.titan.shenzhouxing.com',//体坛注册
    },
    dataBase : {
        tableSet : new Map(),
        table : {
