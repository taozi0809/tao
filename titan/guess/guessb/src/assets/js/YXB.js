...
export const YXB = {
  ...
  // --------------------------------------------------------
  url : {
       coin : "//api.core.titan.shenzhouxing.com",
       // jc : "////api.quiz.titan.shenzhouxing.com",
      // coin : "//192.168.1.150:8000",
      // jc : '//192.168.1.150:7007',

      // coin : "//192.168.1.150:8000",//胡
      jc : '//192.168.1.63:7007',
  },
  dataBase : {
    tableSet : new Map(),
    table : {
