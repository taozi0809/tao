<template>
    <div class="BetInput" id="pos-bot">
        ...
        <div class="btn">
            <span @click="handleQuiz">立即竞猜(最高返还{{returnSum + coinName}})</span>
        </div>
...
<script>
    ...
    import {football_bet} from "../../service/api";
    ...
    export default {
        ...
        methods:{
            ...
            handleQuiz(){
                ...
                football_bet(this.betInfo.matchId,this.userName,this.token,this.coinName,this.moneyCode,this.sum,type,info).then(res=>{
                    console.log(res)
                    if(res.code==='0'){
