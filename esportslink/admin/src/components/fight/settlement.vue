    ...
    <div class="list">
        <el-table :data="list" border style="width: 100%" v-loading="loading"
            ...
            <el-table-column property="name" label="玩家" width="180">
                <template slot-scope="scope">
                    {{scope.row.originateUserInfoDtoModel.phoneNumber}} <br>
            ...
            <div class="judgment">
                ...
                <div class="content">
                    <div class="l">
                        ...
                        <div class="btn">
                            <!--                            <el-button :type="winA?'primary':''" size="small" style="width: 100%;"  @click="winA=!winA">获胜</el-button>-->

                            <el-button size="small" style="width: 100%;" v-if="!isWin" @click="isWin=true,win=true">获胜</el-button>
                            <el-button :type="win?'primary':''" size="small" style="width: 100%;" v-if="isWin" @click="win=true">获胜</el-button>
                        </div>
                    </div>
                    <div class="r">
                        ...
                        <div class="btn">
                            <!--                            <el-button :type="winB?'primary':''" size="small" style="width: 100%;"  @click="winB=!winB">获胜</el-button>-->
                            <el-button size="small" style="width: 100%;" v-if="!isWin" @click="isWin=true,win=false">获胜</el-button>
                            <el-button :type="win?'':'primary'" size="small" style="width: 100%;" v-if="isWin" @click="win=false">获胜</el-button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            platformList(status,result,gameName,pageNum,pageSize){
                ...
                platformList(status,result,gameName,pageNum,pageSize).then(res=>{
                    ...
                    if(res.code==0){
                        ...
                        this.FIGHTSECONDNUM(res.data.totalNum)
                    }
                })
            },
            showDetails(row){
