<template>
    <div class="scoreMain">
        ...
        <div class="match-selection">
            <ul>
                <li :class="matchSelectionActive=='即时比分'?'active':''" @click="matchSelectionActive='即时比分'"><a href="javascript:void (0)">即时比分</a></li>
                <li :class="matchSelectionActive=='完场比分'?'active':''" @click="matchSelectionActive='完场比分'"><a href="javascript:void (0)">完场比分</a></li>
                <li><a href="javascript:void (0)" class="search">
                    <svg class="icon icon-size" aria-hidden="true">
                        <use xlink:href="#iconsousuo"></use>
                    </svg>
                    <div class="name">赛事筛选</div>
                </a></li>
            </ul>
        </div>
                ...
                <li v-for="(item,index) in allGameList" :key="index">
                    <a :href="'/score/'+item.type" class="li-a">
                        <div class="item-top">
                            ...
                            <div class="pushTower">推塔破路</div>
                            <div class="live">LIVE指数</div>
                        </div>
                        <div class="item-main">
                            <div class="gameIndex">
                                {{item.gameIndex}} <br>
                            ...
                            <div class="pushTower">
                                <div class="value">{{item.teama.pushTower}}</div>
                                <div class="value">{{item.teamb.pushTower}}</div>
                            </div>
                            <div class="live">
                                <div class="value">{{item.teama.live}}</div>
                                <div class="value">{{item.teamb.live}}</div>
                            </div>
                        </div>
                    </a>
                </li>
                ...
                li{
                    ...
                    .li-a{
                        ...
                        .item-top{
                            ...
                            .exponent,.camp,.kill,.economic,.experience,.pushTower,.live{
                                flex-shrink: 0;
                                width: 90px;
                                height: 30px;
                                line-height: 30px;
