...
/*运营已经匹配到的直播地址的比赛*/
export const liveAllData=() => post(`${baseUrl.football}/client.do`,{
    method:'live.all.data',
    data:{}
})

/*我们体坛的大于当前时间的比赛*/
export const initMatchData=() => post(`${baseUrl.football}/client.do`,{
    method:'init.match.data',
    data:{}
})
...
/*未转换名字的比赛*/
export const matchNoState=() => post(`${baseUrl.football}/client.do`,{
