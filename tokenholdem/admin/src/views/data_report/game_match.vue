    ...
    <div class="userList">
        ...
        <div class="list">
            <el-table :data="list" style="width: 100%" border height="700" v-loading="loading"
                ...
                <el-table-column prop="GameType" label="房间类型" width="180"></el-table-column>
                ...
                <el-table-column prop="ProfitChips" label="资金变化" width="100"></el-table-column>
                <el-table-column prop="Chips" label="当前余额" width="100"></el-table-column>

                <el-table-column prop="createdat" label="开始时间" width="180">
                    <template slot-scope="scope">
                        {{scope.row.StartAt | timestampToTime1}}
                    </template>
                </el-table-column>
                <el-table-column prop="updatedat" label="结束时间" width="180">
                    <template slot-scope="scope">
                        {{scope.row.EndAt | timestampToTime1}}
                    </template>
                </el-table-column>
