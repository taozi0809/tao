            ...
            <el-table :data="list" style="width: 100%" border height="700" v-loading="loading"
                ...
                <el-table-column label="头像地址" width="60">
                    <template slot-scope="scope">
                        <div class="head-img"><img :src="scope.row.avatar" alt=""></div>
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="chips" label="GACT余额" width="180"></el-table-column>
                <el-table-column prop="usdt" label="USDT余额" width="180"></el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            playerRole(row){
                ...
                data.append('accountid',row.accountid);
                data.append('desc','');
                data.append('role',row.role==-1?'1':'-1');
