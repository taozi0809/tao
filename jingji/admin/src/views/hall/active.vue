...
<!--                <el-table-column type="index" :index="getInIndex" width="50" label="排序"></el-table-column>-->
                ...
                <el-table-column prop="Img" label="活动图片" width="100">
                    <template slot-scope="scope">
                        <el-image style="width:100px;" :src="scope.row.Img" :fit="'scale-down'"></el-image>
                    </template>
                </el-table-column>
                <el-table-column prop="Matchid" label="关联赛事ID" width="200"></el-table-column>
                <el-table-column prop="Link" label="活动链接" width="200"></el-table-column>
                ...
                <el-table-column prop="ClickCnt" label="点击量"></el-table-column>
                <el-table-column fixed="right" label="操作" width="250">
                    <template slot-scope="scope">
                        <el-button type="warning" size="small" @click="activityUpdate(scope.row.ID,scope.row.Order,scope.row.Title,scope.row.Img,scope.row.Matchid,scope.row.Link,scope.row.PrevUpedAt,scope.row.PrevDownedAt,2,scope.row.ClickCnt)" v-if="scope.row.Status==1">下架</el-button>
                        <el-button type="success" size="small" @click="activityUpdate(scope.row.ID,scope.row.Order,scope.row.Title,scope.row.Img,scope.row.Matchid,scope.row.Link,scope.row.PrevUpedAt,scope.row.PrevDownedAt,1,scope.row.ClickCnt)" v-if="scope.row.Status==2">上架</el-button>
        ...
        <div class="dialogMatch">
            <el-dialog
                ...
                <div class="dialog-con">
                    ...
                    <div class="t1">
                        <div class="l">关联赛事：</div>
                        <div class="r">
                            <el-input v-model="Matchid"></el-input>
                        </div>
                    </div>
                    <div class="t1">
                        <div class="l">活动链接：</div>
                        <div class="r">
                    ...
                    <div class="t1 tt">
                        ...
                        <div class="r">
                            ...
                            <el-button type="primary" @click="activityInsert">确 定</el-button>
                        </div>
                    </div>
                </div>
            </el-dialog>
            ...
            <el-dialog
                ...
                <div class="dialog-con">
                    ...
                    <div class="t1">
                        <div class="l">关联赛事：</div>
                        <div class="r">
                            <el-input v-model="obj.Matchid"></el-input>
                        </div>
                    </div>
                    <div class="t1">
                        <div class="l">活动链接：</div>
                        <div class="r">
                            <el-input v-model="obj.Link"></el-input>
                        </div>
                    </div>
                    <div class="t1">
                        <div class="l">上架时间：</div>
                    ...
                    <div class="t1 tt">
                        ...
                        <div class="r">
                            <el-button @click="handleClose1()">取 消</el-button>
                            <el-button type="primary" @click="activityUpdate(obj.ID,obj.Order,obj.Title,obj.Img,obj.Matchid,obj.Link,parseInt(obj.PrevUpedAt/1000),parseInt(obj.PrevDownedAt/1000),obj.Status,obj.ClickCnt)">确 定</el-button>
                        </div>
                    </div>
                </div>
            </el-dialog>
                ...
                <div class="dialog-con">
                    ...
                    <div class="t1 tt">
                        ...
                        <div class="r">
                            ...
                            <el-button type="primary" @click="activityDelete(obj.ID)">确 定</el-button>
                        </div>
                    </div>
                </div>
            </el-dialog>
...
<script>
    ...
    import {activityInsert, activityDelete, activityList, activityUpdate,} from "../../service/api/api";
    ...
    export default {
        ...
        methods:{
            ...
            activityList(){
                ...
                activityList(this.page,this.per,parseInt(this.time[0]/1000),parseInt(this.time[1]/1000),Condition).then(res=>{
                    this.loading=false
                    console.log("活动列表",res)
                    if(res.code==1000){
                        this.list=res.resp.ActivityControls
                        this.count=res.resp.Total
                    }
                })
            },
            activityUpdate(ID,Order,Title,Img,Matchid,Link,PrevUpedAt,PrevDownedAt,Status,ClickCnt){
                activityUpdate(ID,Order,Title,Img,Matchid,Link,PrevUpedAt,PrevDownedAt,Status,ClickCnt).then(res=>{
                    console.log("编辑",res)
                    if(res.code==1000){
            ...
            activityInsert(){
                activityInsert(this.Order,this.Title,this.Img,this.Matchid,this.Link,parseInt(this.PrevUpedAt/1000),parseInt(this.PrevDownedAt/1000)).then(res=>{
                    console.log("添加",res)
                    if(res.code==1000){
