<template>
    <div class="movie reuse-page">
        <Head/>
        <div class="top"></div>
        <section class="contain">
            <p class="title">{{lang.hasOwnProperty('lang')?langCon[lang.lang].movie.name:''}}</p>
            <div class="list">
                <ul>
...
<script>
    ...
    export default {
        metaInfo: {
            title: 'Watch The Best of Chinese Movies Online - Vidfish',
            meta: [{
                name: 'keyWords',
                content: 'chinese movies, watch chinese movies online, free chinese movies online, popular chinese movies 2019, chinese movie streaming'
            },
            {
                name: 'description',
        ...
        methods:{
            ...
            async getBaseList(lang,i) {
                return await new Promise((resolve, reject) => {
                    baseList(this.ip,this.lon,this.lat,'MOVIE',null,null,null,null,lang,i,this.pageSize,this.country).then((res)=>{
