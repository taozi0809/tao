        ...
        <section class="main">
            <div class="con">
                <div class="nav">
                    ...
                    <ul>
                        <li :class="anchor==0?'active':''" @click="handleNav('0')">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.yourAccount:''}}</li>
                        <li :class="anchor==1?'active':''" @click="handleNav('1')">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.membership:''}}</li>
                    </ul>
                </div>
                <div class="details">
                    <div class="account-settings" v-if="anchor==0">
                        <div class="head">
                        ...
                        <div class="form">
                            <div class="form-container" :class="lang.lang=='ZH'?'zh':'en'">
                                <div class="row">
                                    <div class="item">
                                        <p>{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.name:''}}</p>
                                        <div class="r">
                                            <input type="text" v-model="userInfo.userName">
                                            <div class="change" @click="changeUserSetting(token,userInfo.birthday,userInfo.cancellation,userInfo.gender,
                                    userInfo.isPush,userInfo.parentControl,userInfo.parentPassword,userInfo.userName,userInfo.email,
                                    userInfo.phoneNumber,userInfo.changeEmailCode,userInfo.changePhoneCode)">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.change:''}}</div>
                                        </div>
                                    </div>
                                    <div class="c"></div>
                                    <div class="item">
                                ...
                                <div class="row">
                                    <div class="item" v-if="emailType==0">
                                    ...
                                    <div class="item" v-if="emailType==1">
                                        <p>{{lang.hasOwnProperty('lang')?langCon[lang.lang].login.authCode:''}}</p>
                                        <div class="r">
                                            <input type="text" v-model="authCode1">
                                            <div class="change" @click="handleAuthCode1">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.change:''}}（{{timeNum}}s）</div>
                                        </div>
                                    </div>
                                    <div class="item" v-if="emailType==2">
                                        <p>New Email Address</p>
                                        <div class="r">
                                            <input type="text" v-model="email2">
                                            <div class="authCodeBtn" @click="handleSendAuthCode2">{{lang.hasOwnProperty('lang')?langCon[lang.lang].login.authCodeBtn:''}}</div>
                                        </div>
                                    </div>
                                    <div class="item" v-if="emailType==3">
                                        <p>{{lang.hasOwnProperty('lang')?langCon[lang.lang].login.authCode:''}}</p>
                                        <div class="r">
                                            <input type="text" v-model="authCode3">
                                            <div class="change" @click="handleAuthCode3">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.change:''}}（{{timeNum2}}s）</div>
                                        </div>
                                    </div>
                                    <div class="c"></div>
                                    <div class="item">
                                ...
                                <div class="row">
                                    <div class="change-password" @click="handleChangePassword">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.changePassword:''}}</div>
                                    <div class="change-password" @click="handleLogout">{{lang.hasOwnProperty('lang')?langCon[lang.lang].login.logout:''}}</div>
                                </div>
                           </div>
                        </div>
                    </div>
                    <div class="membership-billing" v-if="anchor==1">
                        <div v-if="userInfo.isVip==0">
                            <p class="title">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.membershipTitle:''}}</p>
                            <span><img src="../assets/img/accountSet/viped.png" alt=""></span>
                        </div>
                        <div v-if="userInfo.isVip!=0">
                            <p class="title">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.membershipTitle:''}}</p>
                            <!--<p class="limited">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.limited:''}}</p>-->
                            ...
                            <div class="vip-type-list">
                                <ul>
                                    <li :class="cardIndex==index?'active':''" v-for="(item,index) in payProductCtoModelList" @click="product(index,item)">
                                        <span v-if="cardIndex==index"><img src="../assets/img/accountSet/card-active.png" alt=""></span>
                                        <span v-if="cardIndex!=index"><img src="../assets/img/accountSet/card.png" alt=""></span>
                            ...
                            <!--<div class="promotion-code">-->
                                <!--<p class="label">{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.promotionLabel:''}}</p>-->
                                <!--<div class="value">-->
                            ...
                            <div class="pay-list">
                                ...
                                <div class="paypal-box" :class="cardIndex==0?'show':'hide'">
                                    ...
                                    <div class="price">
                                        <!--<p class="price line" v-if="payIndex==0">USD {{cardIndex==0?'3.0':'30'}}</p>-->
                                ...
                                <div class="paypal-box" :class="cardIndex==1?'show':'hide'">
                                    ...
                                    <div class="price">
                                        <!--<p class="price" v-if="payIndex==0">USD {{cardIndex==0?'3.0':'30'}}</p>-->
                                        <p class="price" v-if="payIndex==0">USD {{cardIndex==0?paypalPriceM:paypalPriceY}}</p>
                                    </div>
                                </div>
                                <ul>
                                    <li v-for="(item,index) in defrayPlatformCtoModelList" @click="buy(item)">
                                        <span><img :src="item.logoPc" alt=""></span>
                                        <div class="price" v-if="item.platform=='Gopay'">
                                            <!--<p class="price line" v-if="payIndex==0">IDR {{cardIndex==0?'26,000':'260,000'}}</p>-->
                            ...
                            <!--<div class="total">-->
                                <!--<div class="l">-->
                                    <!--<p>{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.total1:''}}</p>-->
                                    <!--<p>{{lang.hasOwnProperty('lang')?langCon[lang.lang].account.total2:''}}</p>-->
                                <!--</div>-->
                            <!--</div>-->
                            <div class="vip-privilege">
                                <ul>
                                    <li>
                                        <span><img src="../assets/img/accountSet/icon/icon1.png" alt=""></span>
                                        <p>Huge Content Library</p>
                                    </li>
                                    <li>
                                        <span><img src="../assets/img/accountSet/icon/icon2.png" alt=""></span>
                                        <p>High Definition Videos</p>
                                    </li>
                                    <li>
                                        <span><img src="../assets/img/accountSet/icon/icon3.png" alt=""></span>
                                        <p>Watch History, Bookmarks, Ratings</p>
                                    </li>
                                </ul>
                            </div>
                            
                            <!--<div class="right-web"><img src="../assets/img/pay/gopayweb.jpg" alt=""></div>-->
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            buy(item){
                ...
                if(item.platform=='Gopay'){
                    if(this.cardIndex==0){
                        ...
                        this.midtransGetToken({method:'youxibi.midtrans.get.token', data:{idCode:this.userInfo.idCode,productId:this.id}},YXB.url.zf,agrs)
                    }
                    if(this.cardIndex==1){
                        let agrs={
                            order_id:this.getOrderId(),
            ...
            handleAuthCode1(){
                if(!!this.authCode1){
                    if(this.authCode1==this.authCodeContent){
                        ...
                        this.$refs.message.Message('验证码错误');
                    }
                }
            },
            handleAuthCode3(){
            ...
            paypalPay(total,currency,method,intent,description,rebackSuccessUrl,rebackCancelUrl,idCode,productId,productType){
                paypalPay(total,currency,method,intent,description,rebackSuccessUrl,rebackCancelUrl,idCode,productId,productType).then(res=>{
                    console.log('paypal支付：',res)
                    if(res.code==0){
            ...
            paypalCreatePlan(option,url,type){
                let _this = this
                let data = YXB.getBaseCtoInfo(option.method,option.data)
                ...
                url = url+'?'+data
                let objMonth = {"object":{
                        "product_id": "PROD-9EN756533W322371A",
                        "name": "VIDFISH MONTH",
                        "description": "VIDFISH MONTH",
                        "billing_cycles": [
                            {
                                "frequency": {
                                    "interval_unit": "DAY",
                ...
                let objYear = {"object":{
                        "product_id": "PROD-26L61840LL861642T",
                        "name": "VIDFISH YEAR",
                        "description": "VIDFISH YEAR",
                        "billing_cycles": [
                            {
                                "frequency": {
                                    "interval_unit": "DAY",
                ...
                $.ajax({
                    ...
                    success: function(res){
                        console.log('创建计划:',res)
                        if(res.code==0){
                            let obj = JSON.parse(res.data)
                            let agrs={
                                plan_id:obj.id,
                                start_time:_this.getSstartTime()
                            }
                            _this.paypalCreateSubscription({method:'youxibi.paypal.create.subscription', data:{idCode:_this.userInfo.idCode,productId:_this.id}},YXB.url.zf,agrs)
                        }
                    },
                })
            },
            paypalCreateSubscription(option,url,agrs){
                let _this = this
                let data = YXB.getBaseCtoInfo(option.method,option.data)
                let ret=''
                for (let it in data) {
                ...
                url = url+'?'+data
                let obj = {"object":{
                        "plan_id":agrs.plan_id,
                        "start_time":agrs.start_time,
                        "subscriber":{
                            "name":{
                                "given_name":"John",
                                "surname":"Doe"
                            },
                            "email_address":"787653739@qq.com"
                        },
                        "auto_renewal":true,
                        "application_context":{
                            "brand_name":"example",
                ...
                $.ajax({
                    ...
                    contentType: "application/json;",
                    success: function(res){
                        console.log('创建订阅:',res)
                        if(res.code==0){
                            let obj = JSON.parse(res.data)
                            window.location.href=obj.links[0].href
                        }else{
                            _this.$refs.load.Load(false)
                            _this.$refs.message.Message(res.message);
                        }
            ...
            midtransGetToken(option,url,agrs){
                let _this = this
                let data = YXB.getBaseCtoInfo(option.method,option.data)
                let ret=''
                for (let it in data) {
