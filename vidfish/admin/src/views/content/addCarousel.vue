<template>
    <div class="addCarousel">
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="120px" class="zdy-form">
            ...
            <el-form-item label="关联电影" prop="movieIds">
...
<script>
    ...
    import {baseCatalog,uploadDo,carouselAddUpdate,languageSelect} from "../../service/api";
    ...
    export default {
        ...
        created:function(){
            ...
            baseCatalog('MOVIE').then(res=>{
                console.log('所有电影列表',res)
                if(res.code==='0'){
