<template>
    <div class="video-list">
        <el-table :data="videoBaseCtoModelList" style="width: 100%" height="600">
            ...
            <el-table-column label="电影名称" min-width="250">
            ...
            <el-table-column label="是否有水印" width="100">
                <template slot-scope="scope">
                    <p>{{scope.row.isWater==0?'有':scope.row.isWater==1?'没有':scope.row.isWater}}</p>
                </template>
            </el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            getVideoBaseList(videoName,currentPage){
                videoBaseList('MOVIE',videoName,currentPage,this.pageSize).then(res=>{
