    ...
    <div class="overview">
        ...
        <div class="row">
            ...
            <div class="item">
                ...
                <div class="data">{{data.PaySum}}</div>
                <div class="name">总充值金额</div>
            </div>
            <div class="item" v-if="gameName==0">
                <span><img src="../../assets/images/overview/5.png" alt=""></span>
                <div class="data">{{data.RedpacketSum}}</div>
                <div class="name">发放红包金额</div>
            </div>
            <div class="item">
                <span><img src="../../assets/images/overview/6.png" alt=""></span>
                <div class="data">{{data.ConsumeRoomcard}}</div>
                <div class="name">房卡消耗总数</div>
            </div>
